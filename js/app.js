(() => {
    ...
    function initSliders() {
        if (document.querySelector(".vibe__slider")) new core(".vibe__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                prevEl: ".vibe__slider .swiper-button-prev",
                nextEl: ".vibe__slider .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".workplace-image__slider")) new core(".workplace-image__slider", {
        ...
        if (document.querySelector(".workplace-content__slider")) new core(".workplace-content__slider", {
            ...
            preloadImages: false,
            navigation: {
                prevEl: ".workplace-content__slider .swiper-button-prev",
                nextEl: ".workplace-content__slider .swiper-button-next"
            },
            pagination: {
                el: " .swiper-pagination",
                type: "fraction"
